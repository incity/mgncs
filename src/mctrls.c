...
MGNCS_REGISTER_COMPONENT_EX(mListView, WS_HSCROLL | WS_VSCROLL,
	...
	MGNCS_REGISTER_COMPONENT_EX(mPopupDialog, 0, 0, IDC_ARROW, WE_MAINC_THREED_BODY);
#endif
	...
	MGNCS_REGISTER_COMPONENT(mSwiper);
	MGNCS_REGISTER_COMPONENT(mMarquee);
#endif
...
void ncsUninitialize(void)
{
	...
	MGNCS_UNREG_COMPONENT(mPopupDialog);
#endif
	...
	MGNCS_UNREG_COMPONENT(mSwiper);
	MGNCS_UNREG_COMPONENT(mMarquee);
#endif
